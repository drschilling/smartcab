...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None):
        ...
        self.num_trials += 1
        self.write_state_to_csv(self.alpha, self.num_trials, self.n_penalties, self.destination_reached)
        self.n_penalties = 0
        self.destination_reached = False
    ...
    @staticmethod
    def write_state_to_csv(alpha, num_trials, n_penalties, destination_reached):
        output_file = open('q_learning_output.csv', 'a')
        writer = csv.writer(output_file)
        writer.writerow((alpha,  num_trials, n_penalties, destination_reached))
        output_file.close()
